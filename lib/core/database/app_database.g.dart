...
class $TransactionImagesTable extends TransactionImages
    with TableInfo<$TransactionImagesTable, TransactionImageEntry> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<TransactionImageEntry> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  TransactionImageEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return TransactionImageEntry(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
...
class TransactionImageEntry extends DataClass
    implements Insertable<TransactionImageEntry> {
  final String id;
  ...
  factory TransactionImageEntry.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  TransactionImageEntry copyWith({
    String? id,
  ...
  TransactionImageEntry copyWithCompanion(TransactionImagesCompanion data) {
    return TransactionImageEntry(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('TransactionImageEntry(')
          ..write('id: $id, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is TransactionImageEntry &&
          other.id == this.id &&
...
class TransactionImagesCompanion
    extends UpdateCompanion<TransactionImageEntry> {
  final Value<String> id;
  ...
  TransactionImagesCompanion.insert({
    ...
    this.rowid = const Value.absent(),
       ...
       sizeBytes = Value(sizeBytes),
       createdAt = Value(createdAt);
  static Insertable<TransactionImageEntry> custom({
    Expression<String>? id,
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    WritePropagation(
      ...
      result: [TableUpdate('transaction_images', kind: UpdateKind.delete)],
    ),
  ]);
}
...
class $$TransactionsTableTableManager
    extends
        RootTableManager<
          ...
          TransactionEntry,
          PrefetchHooks Function({bool categoryId, bool transactionImagesRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({categoryId = false, transactionImagesRefs = false}) {
                return PrefetchHooks(
                  db: db,
...
class $$TransactionImagesTableTableManager
    extends
        RootTableManager<
          ...
          (TransactionImageEntry, $$TransactionImagesTableReferences),
          TransactionImageEntry,
